...
public class PlantServiceTest {
    ...
    private static String DEFAULT_TREE_SPECIES = "Pine";
    ...
    public void createPineNotPredefined() {
        Tree tree = plantService.createPine(DEFAULT_PINE_AGE, DEFAULT_PINE_HEIGHT, DEFAULT_TREE_SPECIES);
        assertNotNull(tree);
        assertEquals(DEFAULT_PINE_AGE, tree.getAge());
        assertEquals(DEFAULT_PINE_HEIGHT, tree.getHeight(), DELTA);
    }
    ...
    public void createHeatherNotPredefined() {
        Bush bush = plantService.createHeather(DEFAULT_HEATHER_AGE, DEFAULT_HEATHER_HEIGHT, DEFAULT_BUSH_SPECIES);
        assertNotNull(bush);
        assertEquals(DEFAULT_HEATHER_AGE, bush.getAge());
        assertEquals(DEFAULT_HEATHER_HEIGHT, bush.getHeight(), DELTA);
    }
    ...
    public void createDaisy() {
        Flower daisy = plantService.createFlower(DEFAULT_FLOWER_COLOR, DEFAULT_DAISY_AGE, DEFAULT_DAISY_HEIGHT, "Daisy");
        assertNotNull(daisy);
    ...
    public void createBellflower() {
        Flower bellflower = plantService.createFlower(DEFAULT_FLOWER_COLOR, DEFAULT_DAISY_AGE, DEFAULT_DAISY_HEIGHT, "Bellflower");
