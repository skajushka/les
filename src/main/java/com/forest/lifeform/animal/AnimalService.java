...
public class AnimalService {
    ...
    public static char DEFAULT_CAT_SEX = 'F';
    ...
    public static char DEFAULT_DOG_SEX = 'M';
    ...
    public DomesticCat createDomesticCat(String name, String color, char sex, int age) {
    ...
    public ZwergSchnautzer createZwergSchnautzer(String name, String color, char sex, int age) {
